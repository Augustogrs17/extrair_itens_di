...
def executar_gui():
    ...
    tk.Entry(frame_origem, textvariable=var_origem).pack(side="left", fill="x", expand=True, padx=5)
    ...
    frame_destino1 = tk.Frame(aba_extrair)
    frame_destino1.pack(fill="x", padx=12, pady=5)
    tk.Label(frame_destino1, text="Pasta de destino (Downloads):", width=24, anchor="w").pack(side="left")
    var_destino1 = tk.StringVar(value=PASTA_DESTINO)
    tk.Entry(frame_destino1, textvariable=var_destino1).pack(side="left", fill="x", expand=True, padx=5)
    ...
    tk.Button(frame_destino1, text="...", command=escolher_destino1, width=3).pack(side="left")

    frame_botao1 = tk.Frame(aba_extrair)
    frame_botao1.pack(fill="x", padx=12, pady=(15, 5))
    btn_extrair = tk.Button(frame_botao1, text="Extrair Itens DI", width=16)
    btn_extrair.pack(side="left")
    lbl_status1 = tk.Label(frame_botao1, text="Pronto.", anchor="w")
    lbl_status1.pack(side="left", padx=10, fill="x", expand=True)

    frame_progress1 = tk.Frame(aba_extrair)
    frame_progress1.pack(fill="x", padx=12, pady=(0, 8))
    pbar1 = ttk.Progressbar(frame_progress1, orient="horizontal", mode="determinate")
    pbar1.pack(fill="x")

    frame_detalhes1 = tk.Frame(aba_extrair)
    frame_detalhes1.pack(fill="both", expand=True, padx=12, pady=(0, 5))

    log_widget1 = {"w": None}
    detalhes1_visivel = tk.BooleanVar(value=False)
    ...
    btn_detalhes1 = tk.Button(aba_extrair, text="▼ Mostrar detalhes", relief="flat",
                               fg="gray", command=toggle_detalhes1)
    ...
    # ================= ABA 2: CRUZAR PPAP =================
    frame_di = tk.Frame(aba_cruzar)
    frame_di.pack(fill="x", padx=12, pady=(14, 5))
    tk.Label(frame_di, text="Arquivo 'Itens DI - ...xlsx':", width=24, anchor="w").pack(side="left")
    var_di = tk.StringVar(value="")
    tk.Entry(frame_di, textvariable=var_di).pack(side="left", fill="x", expand=True, padx=5)
    ...
    tk.Button(frame_di, text="...", command=escolher_di, width=3).pack(side="left")

    frame_monday = tk.Frame(aba_cruzar)
    frame_monday.pack(fill="x", padx=12, pady=5)
    tk.Label(frame_monday, text="Arquivo Monday (Qualidade):", width=24, anchor="w").pack(side="left")
    var_monday = tk.StringVar(value="")
    tk.Entry(frame_monday, textvariable=var_monday).pack(side="left", fill="x", expand=True, padx=5)
    ...
    tk.Button(frame_monday, text="...", command=escolher_monday, width=3).pack(side="left")

    frame_destino2 = tk.Frame(aba_cruzar)
    frame_destino2.pack(fill="x", padx=12, pady=5)
    tk.Label(frame_destino2, text="Pasta de destino (Downloads):", width=24, anchor="w").pack(side="left")
    var_destino2 = tk.StringVar(value=PASTA_DESTINO_PADRAO)
    tk.Entry(frame_destino2, textvariable=var_destino2).pack(side="left", fill="x", expand=True, padx=5)
    ...
    tk.Button(frame_destino2, text="...", command=escolher_destino2, width=3).pack(side="left")

    frame_botao2 = tk.Frame(aba_cruzar)
    frame_botao2.pack(fill="x", padx=12, pady=(15, 5))
    btn_cruzar = tk.Button(frame_botao2, text="Cruzar", width=16)
    btn_cruzar.pack(side="left")
    lbl_status2 = tk.Label(frame_botao2, text="Pronto.", anchor="w")
    lbl_status2.pack(side="left", padx=10, fill="x", expand=True)

    frame_progress2 = tk.Frame(aba_cruzar)
    frame_progress2.pack(fill="x", padx=12, pady=(0, 8))
    pbar2 = ttk.Progressbar(frame_progress2, orient="horizontal", mode="determinate")
    pbar2.pack(fill="x")

    frame_detalhes2 = tk.Frame(aba_cruzar)
    frame_detalhes2.pack(fill="both", expand=True, padx=12, pady=(0, 5))

    log_widget2 = {"w": None}
    detalhes2_visivel = tk.BooleanVar(value=False)
    ...
    btn_detalhes2 = tk.Button(aba_cruzar, text="▼ Mostrar detalhes", relief="flat",
                               fg="gray", command=toggle_detalhes2)
